          ...
          >
            <div className="relative aspect-[16/10] lg:aspect-auto lg:h-[78vh] min-h-[520px]">
              <img
                ...
                width={1920}
                height={1280}
                className="absolute inset-0 h-full w-full object-cover opacity-90 transition-transform duration-[1600ms] ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:scale-[1.03]"
              />
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-12 lg:p-16 text-zinc-100">
              ...
              <h1 className="font-display font-black tracking-tight leading-[0.88] text-4xl md:text-6xl lg:text-[5.5rem] max-w-4xl animate-fade-up">
                {featured.title.split(" ").slice(0, -2).join(" ")}{" "}
                <span className="italic text-zinc-400 block md:inline">
              ...
              <div className="mt-8 flex flex-col md:flex-row md:items-end gap-6 md:gap-10">
                ...
                <div className="inline-flex items-center gap-3 border border-zinc-600 py-3 px-6 group-hover:border-zinc-100 group-hover:bg-zinc-100 group-hover:text-[#050505] transition-all duration-500 self-start whitespace-nowrap">
