...
const BASE_URL = "https://welchesfahrrad.de";
    ...
    handlers: {
      GET: async () => {
        ...
        const staticEntries: Array<{
          ...
          { path: "/fahrraeder", changefreq: "daily", priority: "0.9", lastmod: now },
          { path: "/vergleich", changefreq: "monthly", priority: "0.6", lastmod: now },
