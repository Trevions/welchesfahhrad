        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-12 md:gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="mt-5 space-y-2.5 text-sm">
              <li><Link to="/fahrraeder" className="text-muted-foreground hover:text-signal transition-colors">Mountainbike</Link></li>
              <li><Link to="/fahrraeder" className="text-muted-foreground hover:text-signal transition-colors">Trekkingbike</Link></li>
              <li><Link to="/fahrraeder" className="text-muted-foreground hover:text-signal transition-colors">Gravel Bike</Link></li>
              <li><Link to="/fahrraeder" className="text-muted-foreground hover:text-signal transition-colors">Rennrad</Link></li>
              <li><Link to="/fahrraeder" className="text-muted-foreground hover:text-signal transition-colors">City Bike</Link></li>
              <li><Link to="/e-bikes" className="text-muted-foreground hover:text-signal transition-colors">E-Bikes</Link></li>
              <li><Link to="/fahrraeder" className="text-muted-foreground hover:text-signal transition-colors">Lastenrad</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="mt-5 space-y-2.5 text-sm">
              <li><Link to="/fahrraeder" className="text-muted-foreground hover:text-signal transition-colors">Cube</Link></li>
              <li><Link to="/fahrraeder" className="text-muted-foreground hover:text-signal transition-colors">Canyon</Link></li>
              <li><Link to="/fahrraeder" className="text-muted-foreground hover:text-signal transition-colors">Trek</Link></li>
              <li><Link to="/fahrraeder" className="text-muted-foreground hover:text-signal transition-colors">Specialized</Link></li>
              <li><Link to="/fahrraeder" className="text-muted-foreground hover:text-signal transition-colors">Scott</Link></li>
              <li><Link to="/fahrraeder" className="text-muted-foreground hover:text-signal transition-colors">Haibike</Link></li>
